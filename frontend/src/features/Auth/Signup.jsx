...
import { Link } from "react-router-dom";
import { Star, PawPrint, Eye, EyeOff } from "lucide-react";
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      value={formData.password}
                      onChange={(e) => updateFields({ password: e.target.value })}
                      className="w-full px-4 py-2 rounded-xl border border-slate-200 outline-none focus:border-indigo-500 text-sm transition-all bg-slate-50/30 pr-10"
                      required
                    />
                    <button
                      type="button"
