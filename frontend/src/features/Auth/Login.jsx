...
import React, { useState } from 'react';
import { Link, useLocation, useNavigate } from 'react-router-dom';
import { Star, PawPrint, Eye, EyeOff } from 'lucide-react'; // Eye aur EyeOff import kiye
import { authService } from '../../services';
import { getDashboardPath, normalizeRole, saveAuthSession } from '../../utils/auth';
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={password}
                    onChange={(e) => setPassword(e.target.value)}
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 outline-none focus:border-indigo-500 text-sm transition-all focus:ring-4 focus:ring-indigo-50 pr-10"
                    required
                  />
                  <button
                    type="button"
