          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto">
            ...
            <div className="md:col-span-7 relative h-[350px] md:h-[600px] group overflow-hidden rounded-[40px] shadow-lg">
              <div
                ...
                style={{ backgroundImage: `url("https://images.unsplash.com/photo-1593134257782-e89567b7718a?w=1000")` }}
              />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-6">
                <div className="relative h-[250px] md:h-[285px] group overflow-hidden rounded-[32px] cursor-pointer shadow-md">
                  <div
                    role="img"
                    aria-label="Active"
                    className="w-full h-full bg-center bg-cover group-hover:scale-110 transition-all duration-700"
                    style={{ backgroundImage: `url("https://images.unsplash.com/photo-1534361960057-19889db9621e?w=500")` }}
                  />
                ...
                <div className="relative h-[250px] md:h-[285px] group overflow-hidden rounded-[32px] cursor-pointer shadow-md">
                  <div
                    ...
                    className="w-full h-full bg-center bg-cover group-hover:scale-110 transition-all duration-700"
                    style={{ backgroundImage: `url("https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=500")` }}
                  />
                  <div className="absolute inset-0 bg-black/40 flex items-end p-8">
