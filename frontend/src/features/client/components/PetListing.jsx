...
//     const [sellRes, meetingRes, dayCareRes] = await Promise.all([
//       listingService.getHomeListings({
//         type: 'sell',
//         filter,
//         limit: 8,
//       }),
...
//     if (!isAuthenticated()) {
//       return alert('Please login to use favorites');
//     }
...
//                 {activeTab === tab && (
//                   <span className="absolute bottom-0 left-0 w-full h-[3px] bg-indigo-600 rounded-full"></span>
//                 )}
//               </button>
//             ))}
//           </div>
    ...
    <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-shadow">
      ...
      <div className="relative h-40 sm:h-64 overflow-hidden">
        ...
        {isVideo ? (
          ...
          <img src={image} alt={listing.breed} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
        )}
      </div>
